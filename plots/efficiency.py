...
with open(os.path.join(ROOT, "data","thermo" ,'result_reverse_s0.5_beta1.pkl'), 'rb') as f:
    [beta_eff, mean_E, var_E, mean_Q, var_Q] = pickle.load(f)
with open(os.path.join(ROOT, "data","thermo", "results_eff_reverse_beta_1_s_0.5.pkl"), "rb") as f:
...
plt.tight_layout()
plt.savefig("nthVSncomp_reverse.pdf")
plt.show()